...
def energy_matrix_with_real(x0=-9.5 * 10 ** -2, y0=0, r=2.4 * 10 ** -2, m=0.63, count_of_magnets=3, x_resolution=2, y_resolution=2, x_size=0.7*10**-2, y_size=2.3*10**-2):
        ...
        for j in range(count_of_magnets):
            ...
            for x_deps in range(x_resolution):
                ...
                for y_deps in range(y_resolution ):
                    ...
                    alpha = 0.000000000000001 + curr_angle + j * delta_angle
